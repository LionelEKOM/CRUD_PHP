        ...
        <form action="" method="post" style="width: 55vw; min-width: 300px;">
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input class="form-control" type="text" name="first_name" id="" placeholder="Lionel">
                </div>
                <div class="col">
                    <label class="form-label">Nom :</label>
                    <input class="form-control" type="text" name="last_name" id="" placeholder="EKOM">
                </div>
            </div>
            <div class="col mb-3">
                <label class="form-label">Email :</label>
                <input class="form-control" type="email" name="user_email" id="" placeholder="name@gmail.com">
            </div>
